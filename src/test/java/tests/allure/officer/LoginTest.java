...
public class LoginTest {
    ...
    public void testLogin() {
        ...
        wait.until(ExpectedConditions.urlContains("/responsibleOfficer/dashboard")); // or change this based on your app

        // Assert success by checking URL or user element
        String currentUrl = driver.getCurrentUrl();
        Assert.assertTrue(currentUrl.contains("/responsibleOfficer/dashboard"), "Login failed or unexpected redirection.");
    }
